...
public class SearchApp
{
    ...
    private static ArrayList<String> LoadWordList()
    {
        ...
        try
        {
            java.io.File file = new File("resources/ThreeLetterWords.txt");
    ...
    private static Integer[] GetRandomNumbers(int size, int max, int min, int seed)
    {
        ...
        for(int i = 0; i < size; i++)
        {
            ...
            do
            {
                ...
                matchIndex = LinearSearch.Linear(number, numbers);
    ...
    private static String[] GetRandomWords(int size, int seed, ArrayList<String> words)
    {
    ...
    private static void TestLinearSearchWithIntegers(Integer[] numbers)
    {
        ...
        // Perform Searches
        fiveNumbersResult = LinearSearch.Linear(searchKey, fiveNumbers);
        tenNumbersResult = LinearSearch.Linear(searchKey, tenNumbers);
        fifteenNumbersResult = LinearSearch.Linear(searchKey, fifteenNumbers);
   ...
   private static void TestLinearSearchWithStrings(String[] words)
    {
        ...
        // Perform Searches
        fiveWordsResult = LinearSearch.Linear(searchKey, fiveWords);
        tenWordsResult = LinearSearch.Linear(searchKey, tenWords);
        fifteenWordsResult = LinearSearch.Linear(searchKey, fifteenWords);
